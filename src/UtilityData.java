...
public class UtilityData
{
    ...
    public void printYearOnYearCosts()
    {
	// The previous data point - if we encounter a new value then we have
        ...
        try
        {
            for (int i = 0; i < utilityReadings.size(); i++)
            {
                ...
                if (prevYear != year)
                {
                    ...
                    stream = new PrintStream("/home/cmb/misc/Home/StationRoad/Utilities/GeneratedFiles/Year" + year + ".dat");
        ...
        try
        {
            stream = new PrintStream("/home/cmb/misc/Home/StationRoad/Utilities/Yearly.plot");
            stream.printf("#----------------------------------------------------------------------\n" +
                          ...
                          "@termpng03\n" +
                          "\n" +
                          "set output \"GeneratedFiles/Graphs/Yearly01.png\"\n" +
            ...
            {
                stream.printf("    \"/home/cmb/misc/Home/StationRoad/Utilities/GeneratedFiles/Year%d.dat\" using 1:4 with lines title \"%d\"%s\n",
                              i, i, (i == year) ? " " : ",\\");
            }
            stream.close();
        }
